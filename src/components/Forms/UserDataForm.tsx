  ...
  return (
    <>
      <p className={styles.paragraph}>
        {`Welcome, ${form.getValues('firstName')} ${form.getValues(
          'lastName',
        )}`}
      </p>
      <div className={styles.user_data_main}>
        <div className={styles.registration_data_name}>
          <form
            ...
            style={background}>
            <label className={styles.span_head}>Your e-mail:</label>
            <InputText
            ...
            <label className={styles.span_head}>Your first name:</label>
            <InputText
              readOnly={switchReadOnly}
              className="mb-1 border-round-lg"
            ...
            <label className={styles.span_head}>Your last name:</label>
            <InputText
              readOnly={switchReadOnly}
              className="mb-1 border-round-lg"
            ...
            <label className={styles.span_head}>Date of your birth</label>
            <InputText
              readOnly={switchReadOnly}
              className="mb-1 border-round-lg"
              type={'date'}
